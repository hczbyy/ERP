...
(function () {
  ...
  /* 路由表 */
  const ROUTES = {
    "/dashboard": { title: "仪表盘", page: () => Pages.dashboard, perm: "dashboard:view" },
    "/products": { title: "商品管理", page: () => Pages.master.product, perm: "master:product:read" },
    "/customers": { title: "客户管理", page: () => Pages.master.customer, perm: "master:customer:read" },
    "/suppliers": { title: "供应商管理", page: () => Pages.master.supplier, perm: "master:supplier:read" },
    "/warehouses": { title: "仓库管理", page: () => Pages.master.warehouse, perm: "master:warehouse:read" },
    "/purchase-orders": { title: "采购订单", page: () => Pages.purchase.orders, perm: "purchase:order:read" },
    "/stock-ins": { title: "收货入库", page: () => Pages.purchase.stockIns, perm: "purchase:order:read" },
    "/sales-orders": { title: "销售订单", page: () => Pages.sales.orders, perm: "sales:order:read" },
    "/stock-outs": { title: "发货出库", page: () => Pages.sales.stockOuts, perm: "sales:order:read" },
    "/stocks": { title: "库存查询", page: () => Pages.inventory.stocks, perm: "inventory:stock:read" },
    "/stock-logs": { title: "库存流水", page: () => Pages.inventory.logs, perm: "inventory:stock:read" },
    "/checks": { title: "盘点管理", page: () => Pages.inventory.checks, perm: "inventory:manage" },
    "/transfers": { title: "库存调拨", page: () => Pages.inventory.transfers, perm: "inventory:manage" },
    "/receivables": { title: "应收账款", page: () => Pages.finance.receivables, perm: "finance:read" },
    "/payables": { title: "应付账款", page: () => Pages.finance.payables, perm: "finance:read" },
    "/receipts": { title: "收款单", page: () => Pages.finance.receipts, perm: "finance:read" },
    "/payments": { title: "付款单", page: () => Pages.finance.payments, perm: "finance:read" },
    "/users": { title: "用户管理", page: () => Pages.system.users, perm: "system:user:manage" },
    "/roles": { title: "角色权限", page: () => Pages.system.roles, perm: "system:role:manage" },
    "/departments": { title: "部门管理", page: () => Pages.system.departments, perm: "system:org:manage" },
    "/employees": { title: "员工管理", page: () => Pages.system.employees, perm: "system:org:manage" },
    "/audit-logs": { title: "审计日志", page: () => Pages.system.auditLogs, perm: "system:audit:read" },
  };
